...
public class AmazonClientManager {
    ...
    public boolean isLoggedIn() {
        return ( AmazonSharedPreferencesWrapper.getUidForDevice( this.sharedPreferences ) != null && AmazonSharedPreferencesWrapper.getKeyForDevice( this.sharedPreferences ) != null );
    }

    public Response login( String username, String password ) {
        AmazonTVMClient tvm = new AmazonTVMClient( this.sharedPreferences, PropertyLoader.getInstance().getTokenVendingMachineURL(), PropertyLoader.getInstance().getAppName(), PropertyLoader.getInstance().useSSL() );
