	...
	public void wireButtons() {
    	okButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				try {
					Response response = AWSAndroidDemoTVMIdentity.clientManager.login( username.getText().toString(), password.getText().toString() );
    	...
    	registerButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				try{
                    String registerURL = ( PropertyLoader.getInstance().useSSL() ? "https://" : "http://" ) + PropertyLoader.getInstance().getTokenVendingMachineURL() + "/register.jsp";                                
